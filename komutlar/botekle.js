...
if (message.channel.id !=kinal) return message.channel.send(`Bot ekleme kodunu Sadece bot ekleme kanalında kullanabilirsin. O kanal ayarlı ise <#${kinal}> Kullanabilirsin degilse v!botekle-log-kanal #kanal`)
